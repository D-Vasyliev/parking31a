...
- [x] **Етап 3** — мапа + картки місць, власники (з історією), нотатки
- [x] **Етап 4** — проєкти (поділ вартості, оплати, перерахунок, автонотатки, стан-машина)
- [x] **Етап 5** — мультивибір на мапі (групові дії) + глобальний пошук
- [x] **Етап 6** — журнал аудиту, користувачі, безпека акаунта, cron-бекап, мобільний режим
